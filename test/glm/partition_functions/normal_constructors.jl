...
@testset "Linear Regression Constructors" begin
    ...
    for type in types
        ...
        #Verify sizes and types 
        let resp=randn(type, 1), feat=zeros(type, 1, 3)
            problem = constructor(resp=resp, feat=feat)
        ...
        #Verify sizes and types 
        let resp=randn(type, 10), feat=zeros(type, 10, 3)
            problem = constructor(resp=resp, feat=feat)
